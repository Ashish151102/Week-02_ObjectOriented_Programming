...
public class Company_Departments {
    public static void main(String[] args) {
        ...
        Company company = new Company("Techno.in");
        ...
        dept1.addEmployee(new Employee("Tom", " Scientist"));
        dept1.addEmployee(new Employee("john", " Analyst"));

        dept2.addEmployee(new Employee("Charlie", "HR Manager"));
        dept2.addEmployee(new Employee("harry", "Recruiter"));
