...
public class VehicleManagement_System {
    public static void main(String[] args) {

        // Creating an ElectricVehicle object
        ElectricVehicle electricVehiclev = new ElectricVehicle("Tesla3", 250, 75);
        ...
        PetrolVehicle petrolVehicle = new PetrolVehicle("Tata", 180, 50);
