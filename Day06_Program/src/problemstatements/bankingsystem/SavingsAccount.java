...
public class SavingsAccount extends BankAccount implements Loanable {
        public static double rateOfInterest = 0.04;

        // constructor to initialize an account
        public SavingsAccount(int accountNumber, String holderName, double initialBalance, int age){
        ...
        public void applyForLoan(int creditScore){
            System.out.print(getName() + " applied for loan !");
