...
public class Ecommerce_platform {
    public static void main(String[] args) {
        ...
        // Creating products
        Product product1 = new Product("Laptop", 1999.99);
        Product product2 = new Product("Mobile", 1699.99);
        Product product3 = new Product("Headphones", 299.99);
        Product product4 = new Product("Keyboard", 149.99);

        // Creating orders for Tom
        ...
        order3.AddProduct(product2); // Mobile
