...
public class HospitalDoctors_Patients{
    public static void main(String[] args) {
        ...
        Patient patient1 = new Patient("Tom");
        ...
        doctor1.consult(patient1); // Dr. john consults Tom
        doctor1.consult(patient2); // Dr. john consults Bob
