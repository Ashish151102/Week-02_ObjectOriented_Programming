...
public class UniversityFaculty_Departments {
    public static void main(String[] args) {
        ...
        Department civilDept = new Department("civil");

        // Adding faculty to departments
        csDept.add_Faculty(faculty1); // Dr. Tom belongs to CS
        csDept.add_Faculty(faculty3); // Dr. Chals belongs to CS
        civilDept.add_Faculty(faculty2); // Dr. Bob belongs to civil

        // Adding departments to the university (composition)
        university.addDepartment(csDept);
        university.addDepartment(civilDept);
