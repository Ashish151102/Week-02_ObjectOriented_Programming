...
public class University_ManagementSystem {
    public static void main(String[] args) {
        ...
        Course course2 = new Course("Maths 201");
        ...
        course1.enrollStudent(student1); // Tom in CS101
        course1.enrollStudent(student2); // peter in CS101
        course2.enrollStudent(student2); // peter in Math201
        course3.enrollStudent(student3); // Bob in Physics301
