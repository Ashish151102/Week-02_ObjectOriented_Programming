...
class Product {
    ...
    static double discount = 15.0;  // 15% discount by default
...
public class ShoppingCart_System {
    public static void main(String[] args) {
        ...
        Product product1 = new Product("Laptop", 150000, 2, "R001");
        Product product2 = new Product("Smartphone", 50000, 4, "R002");
        ...
        Product.updateDiscount(25.0); // 25% discount
