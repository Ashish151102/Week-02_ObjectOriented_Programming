...
public class Banking_System {
    public static void main(String[] args) {
        BankAccount savings = new SavingsAccount("SA12345", 1000.00, 3.5);
        BankAccount checking = new CheckingAccount("CA67890", 500.00, 2000.00);
        BankAccount fixedDeposit = new FixedDepositAccount("FDA11223", 10000.00, 5);
